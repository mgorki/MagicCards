...
from general.variables import ser, q, ITI500
from experiment.config_experiment import behaviour, trial_max
from general.arduino import card_input, readSer


def checkCorrectness(word_number, card_number, data):  # Function returns whether response is correct or not (boolean)
...
def block(practice, block_number):
    ...
    while trial_number <= trial_max:
        ...
        data.update({"ResponseCorrect": checkCorrectness(word_number, card_number, data)})  # Checking whether response was correct and appending this information (boolean) to data
