...
block_max = 1 #10  # Number of blocks to be performed (plus one practice block at the beginning) LOW NUMBER ONLY FOR DEBUGING! ADJUST IT IN THE FINAL EXPERIMENT!!!
...
PERCENTAGECORRECTCARD = 60  # The chance (in percent) that the image of the correct card is presented by the computer at the end of a given block
...
DELAY_EFFECT1 = 0.8  # Delay between reaction and effect (circle) onset (in seconds) for key1
DELAY_EFFECT2 = 0.2  # Delay between reaction and effect (circle) onset (in seconds) for key2
